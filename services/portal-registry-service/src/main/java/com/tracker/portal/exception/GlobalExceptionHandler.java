...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DuplicatePortalException.class)
    public ResponseEntity<Map<String, Object>> handleDuplicate(DuplicatePortalException ex, HttpServletRequest req) {
        // Duplicate domain -> 409 with the existing portal in `data`.
